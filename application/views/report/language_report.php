    ...
    <section class="content">
        ...
        <div class="box box-default">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box">
                        <form method="post" id="get_report" action="<?php echo base_url(); ?>index.php/report/get_outward_lang" onsubmit="get_report();">
                            <div class="col-md-2">
                                <label> Language</label>
                                <select class="form-control select2"  name="language"  data-placeholder="Select a Language" style="width: 100%;"> <!-- multiple="multiple" -->
                                    <option></option>
                                    <?php
                                    foreach ($language as $lang) {
                                        echo"<option>$lang->language_name</option>";
                                    }
                                    ?>
                                </select>
                        ...
                        <div class="box-body" style="overflow-y: scroll; height: 450px;" id="mydiv">
                            <h3 style="text-align:center">Language Report</h3>
