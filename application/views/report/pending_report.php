    ...
    <section class="content">
        ...
        <div class="box box-default">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box">
                        <form method="post" id="get_report" action="<?php echo base_url(); ?>index.php/report/get_pending_outward" onsubmit="get_report();">
                        ...
                        <div class="box-body" style="overflow-y: scroll; height: 450px;" id="mydiv">
                            <h3 style="text-align:center">Pending Report</h3>
