    ...
    <section class="content">
        ...
        <div class="box box-default">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box">
                        <form method="post" id="get_report" action="<?php echo base_url(); ?>index.php/report/type_vip" onsubmit="get_report();">
                            <div class="col-md-2">
                                <label> Type</label>
                                <select class="form-control select2"  name="type"  data-placeholder="Select type" style="width: 100%;"> <!-- multiple="multiple" -->
                                    <option></option>
                                    <?php
                                    foreach ($type as $ty) {
                                        echo"<option>$ty->name</option>";
                                    }
                                    ?>
                                </select>
                        ...
                        <div class="box-body" style="overflow-y: scroll; height: 450px;" id="mydiv">
                            ...
                            <table class="table table-bordered table-striped"> <!--  id="example1" -->
                                ...
                                <tbody  id="out">
                                    <?php
                                    $i = 1;
                                    foreach ($pending_list as $inward_s) {
                                        echo"<tr>
                                               <td>$i</td>
                                                ...
                                                <td>$inward_s->all_document_remark_address_to</td>
                                                <td>$inward_s->file_number_name</td>
                                                <td>$inward_s->statuss</td>
                                                
                                                <td>$inward_s->time_taken</td>
                                            </tr>";
                                        $i++;
                                    }
                                    ?>
