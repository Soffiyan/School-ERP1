...
<div class="box-header with-border"><h3 class="box-title">Total Due List </h3></div>
<div class="nav-tabs-custom">
    <div class="tab-content">
        <div class="tab-pane active" id="tab_1">
            <?php
            $tdates = date('Y-m-d');
            $list = $this->library_model->total_due_borrow_list($tdates);
            ?>
                    ...
                    foreach ($list as $row) {
                        ...
                        <tr>
                            ...
                            if ($dayss < 0) {
                                ...
                                ?>
                                <td><a href="#"  class="acopy"><?php echo $dayss ?> Days Left</a></td>
                            <?php }
                            ?>
                        </tr>
                        <?php
