        ...
        <div class="row">
            <div class="col-md-12 box box-solid">
                <div class="pad_left_right">
                    Home&nbsp;&nbsp;>&nbsp;&nbsp;Library <a href='' class='fa fa-eye' data-toggle='modal' onclick='get_inward_data($inward_s - > document_no);' data-target='.bs-example-modal-lg'></a>
                </div>
            </div>
            <div class="col-md-12 box box-solid">
                <div class="col-md-3">
                    <div class="box box-solid" style="background:#fbfbfb">
                        <!-- Menu -->
                        <?php
                        $this->load->view('library_menu/lib_menu');
                        ?>
                        <!-- Menu end -->
                    </div>
                </div>
