<html>
    ...
    <body>
        <div class="container-fluid">
            <?php
            echo form_open('inventory/inventory/edit_receiver');
            ?>
            <div class="col-lg-4">
                ...
                <div class="form-group has-feedback">
                    <label for="name">Enter the Receiver Name</label><input type="text" value="<?php echo $row->name; ?>" name="name" id="name" required="required" class="form-control">
                </div>
                <div class="form-group has-feedback">
